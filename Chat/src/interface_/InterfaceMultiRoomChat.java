			...
			gl_rooms.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_rooms.createSequentialGroup()
					...
					.addGroup(gl_rooms.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_rooms.createParallelGroup(Alignment.LEADING)
							.addGroup(gl_rooms.createSequentialGroup()
								...
								.addGap(18))
							.addGroup(gl_rooms.createSequentialGroup()
								.addComponent(chatTextPlace, GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE)
					...
					.addGroup(gl_rooms.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(clientConnected, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 219, Short.MAX_VALUE)
						.addComponent(sendButton, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE))
					.addContainerGap())
		);
		gl_rooms.setVerticalGroup(
			gl_rooms.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_rooms.createSequentialGroup()
					...
					.addGroup(gl_rooms.createParallelGroup(Alignment.LEADING)
						.addComponent(clientConnected, GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE)
						.addComponent(chatTextPlace, GroupLayout.DEFAULT_SIZE, 303, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_rooms.createParallelGroup(Alignment.BASELINE)
